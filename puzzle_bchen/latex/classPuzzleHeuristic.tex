...
{\em tiles} & \-A pointer to the tiles of the board that needs its heuristic calculated. \\
\hline
{\em size} & \-The size of the tile list that is having its \-Heuristic computed. \\
\hline
\end{DoxyParams}
